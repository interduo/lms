...
*/
    ...
    public function SendSMS($number, $message, $messageid = null, $sms_options = null)
    {
        ...
        $phone_number_validation_pattern = $sms_options['phone_number_validation_pattern'] ?? ConfigHelper::getConfig('sms.phone_number_validation_pattern',
            '', true);
        ...
        $transliterate_message = $sms_options['transliterate_message'] ?? ConfigHelper::getConfig('sms.transliterate_message',
            'false');
        ...
        foreach (explode(',', $service) as $service) {
            ...
            switch ($service) {
                case 'smstools':
                    $dir = $sms_options['smstools_outdir'] ?? ConfigHelper::getConfig('sms.smstools_outdir',
                    ...
                    $delivery_reports = $sms_options['delivery_reports'] ?? ConfigHelper::getConfig('sms.delivery_reports',
                        'false');
