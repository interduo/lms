...
class LMSEventManager extends LMSManager implements LMSEventManagerInterface
{
    public function EventAdd($event)
    {
        $args = array(
            ...
            'netnodeid' => empty($event['netnodeid']) ? null : $event['netnodeid'],
            'netdevid' => empty($event['netdevid']) ? null : $event['netdevid'],
        );
    ...
    public function GetEventList(array $params)
    {
        ...
        $netdevfilter = empty($netdevid) ? null : ' AND events.netdevid = ' . intval($netdevid);
        $netnodefilter = empty($netnodeid) ? null : ' AND events.netnodeid = ' . intval($netnodeid);
