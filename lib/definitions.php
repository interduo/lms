...
define('RT_RIGHT_OWNERNOTICE', 32);
define('RT_RIGHT_VERIFIERNOTICE', 64);

$RT_RIGHTS = array(
    RT_RIGHT_READ => trans("Read"),
    RT_RIGHT_WRITE => trans("Write (+R)"),
    RT_RIGHT_DELETE => trans("Delete (+R)"),
    RT_RIGHT_NOTICE => trans("Notify Queue Users (+R)"),
    RT_RIGHT_OWNERNOTICE => trans("Notify Owner (+R)"),
    RT_RIGHT_VERIFIERNOTICE => trans("Notify Verifier (+R)"),
