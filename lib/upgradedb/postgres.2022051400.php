...
$this->Execute("ALTER TABLE events ADD COLUMN netnodeid integer");
...
$this->Execute("ALTER TABLE events ADD COLUMN netdevid integer");
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2022051400', 'dbversion'));
