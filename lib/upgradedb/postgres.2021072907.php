...
define('DOC_FLAG_NET_ACCOUNT_2021072907', 16);
...
$this->Execute(
    ...
    array(
        DOC_FLAG_NET_ACCOUNT_2021072907,
        DOC_FLAG_NET_ACCOUNT_2021072907,
        DOC_FLAG_NET_ACCOUNT_2021072907,
        DOC_FLAG_NET_ACCOUNT_2021072907,
        DOC_FLAG_NET_ACCOUNT_2021072907,
...
$this->Execute("UPDATE dbinfo SET keyvalue = ? WHERE keytype = ?", array('2021072907', 'dbversion'));
