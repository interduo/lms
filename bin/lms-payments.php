...
$backward_periods = array(
    DAILY      => Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    WEEKLY     => Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-7, $year))  .' - '.Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    MONTHLY    => Utils::strftime($date_format, mktime(12, 0, 0, $month-1, $dom, $year))  .' - '.Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    QUARTERLY  => Utils::strftime($date_format, mktime(12, 0, 0, $month-3, $dom, $year))  .' - '.Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    HALFYEARLY => Utils::strftime($date_format, mktime(12, 0, 0, $month-6, $dom, $year))  .' - '.Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    YEARLY     => Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom, $year-1)).' - '.Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year)),
    DISPOSABLE => Utils::strftime($date_format, mktime(12, 0, 0, $month, $dom-1, $year))
);
